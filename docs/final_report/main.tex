...
\newpage
\input{product_research/main}
\newpage
\input{architecture/main}
\newpage
\input{auth/main}
\newpage
\input{sources_parsing/main}
\newpage
\input{llm_summarization}
\newpage
\input{fault_tolerance/main}
\newpage
\input{observability/main}
\newpage
\input{ci_cd.tex}
\newpage
\input{testing/main}
...
\begin{appendices}
    ...
    \input{appendices/ta_questionnaire}
    
    \newpage
    \input{appendices/launch_instructions/main}
\end{appendices}
